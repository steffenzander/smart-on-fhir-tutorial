...
function buildTokenRequest(env, code, state) {
  ...
  // Basic authentication is required, where the username is the appâ€™s
  // client_id and the password is the appâ€™s client_secret (see example).
 ...
 *    While this should be valid, we canâ€™t promise that every EHR will allow you
 ...
 *    - You should wrap all your appâ€™s code in a function that is only executed
 *      after `init()` resolves!
 ...
 *    scope. Once the access_token expires, if you donâ€™t have a refresh_token
